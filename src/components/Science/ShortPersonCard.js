  ...
  return (
    <div className="pl-2 mb-2" style={{borderLeft: '4px solid #fd7e14'}}>
      ...
      <div className="d-flex flex-wrap">
          { tel && <div><span className="mr-1"><FontAwesomeIcon icon="phone" style={{color: 'var(--green)'}} size="sm"/></span> <span className="mr-4">{tel}</span></div>}
          { mail && <div><span className="mr-1"><FontAwesomeIcon icon="envelope" style={{color: 'var(--green)'}} size="sm"/></span><span>{mail}</span></div>}
      </div>
      <div>
