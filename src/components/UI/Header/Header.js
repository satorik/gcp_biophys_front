...
const Header = () => {
    ...
    switch (currentSection){
      ...
      case 'education':
          return <QuoteHeader 
            header='https://storage.googleapis.com/biophys-node-dck.appspot.com/images/header/header-education.jpg' 
          />
      case 'science':
          return <QuoteHeader 
      ...
      case 'department':
          return <QuoteHeader 
             header='https://storage.googleapis.com/biophys-node-dck.appspot.com/images/header/header-department.jpg'
          />
      // case 'news':
      //   return <HeaderNews />
      default:
